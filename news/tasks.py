...
def fetch_and_store_news():
    logger.info("Début de l'exécution de fetch_and_store_news") # Log pour débuter la tâche
    ...
    keywords = [
        ...
        'technologie OR innovation OR tech',
    ...
    logger.info("Fin de l'exécution de fetch_and_store_news")  # Log pour finir la tâche
